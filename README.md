[![Build Status](https://travis-ci.org/JeremyFoucault-WCS/js-training.svg?branch=master)](https://travis-ci.org/nan-academy/js-training)
## Setup
First, [**fork**](https://github.com/JeremyFoucault-WCS/js-training/fork?fragment=1) this repository.
